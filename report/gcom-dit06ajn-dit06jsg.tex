...
\subsubsection{Group discovery}\label{sec:group-discovery}
...
For logging capacities \textit{GCom} uses \textit{Simple Logging
...
\textit{Logger}\footnote{http://logback.qos.ch/}. This combination
provides logging capabilities to get information about \textit{GCom}s
status at run-time.
