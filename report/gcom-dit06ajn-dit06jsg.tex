...
Each group member has a referens to a remote object for each
other group member.
...
\subsection{FIFO ordering tests}\label{sec:fifo-tests}
...
\subsection{Casual ordering tests}\label{sec:casual-ordering-tests}
\begin{table}[H]
  \centering
  \begin{footnotesize}
    \begin{tabular} {c | c | c}
...
\subsection{Total ordering tests}\label{sec:total-ordering-tests}
...
\subsection{Casual-Total ordering tests}\label{sec:casual-total-ordering-tests}
