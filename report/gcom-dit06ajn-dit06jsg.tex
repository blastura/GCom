...
It can be viewed in \vref{fig:images/guiapp}. To test the 
...
\ref{tbl:fifo}-\ref{tbl:castot}. The interface is shown in 
\vref{fig:images/Debuggerstart} and \vref{fig:images/holdqueues}.
