...
public abstract class AbstractGroupMember implements GroupMember {
     ...
     *            GNS port
     * @param groupName
     *            Group name to connect to
     * @throws RemoteException
     *             If GNS throws exception
     * @throws AlreadyBoundException
     *             If it's not possible to bind this to own registry.
     * @throws NotBoundException
     *             If GNS stub is not found in GNS register.
     */
    public AbstractGroupMember(String gnsHost, int gnsPort, String groupName)
        ...
        Registry registry = LocateRegistry.createRegistry(1099); // TODO: change
                                                                 // 1099
